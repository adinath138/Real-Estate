...
<div id="page-wrapper">
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Explore Your</span><br>
                                Perfect Dream Home</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We offer comprehensive selling services to help you get the best value for your property. From property evaluation to closing the deal, we manage every step efficiently and transparently.  </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Find the perfect rental property or list your space with ease. Our rental services connect tenants and property owners for a hassle-free experience with reliable support.  </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Showcase your property to a wide audience with our easy-to-use listing service. We ensure maximum visibility and attract potential buyers or tenants quickly.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Invest with confidence—our team ensures every property meets legal standards. We provide expert guidance on legal processes to protect your investments. </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/123.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We pride ourselves on being a top-rated real estate platform, trusted by countless clients for delivering exceptional properties and seamless transactions. </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Discover premium properties that meet the highest standards. We ensure every listing is verified, offering you the best in design, location, and value. </p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of experienced and dedicated real estate professionals is here to guide you every step of the way—making your property journey smooth and successful. </p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We begin with a thorough consultation to understand your property needs. Our experts provide personalized advice to help you make informed decisions with confidence.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Our team carefully reviews all necessary documents to ensure accuracy and compliance. We handle the paperwork, so you can focus on your property goals stress-free.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Secure your dream property with our seamless acquisition process. From negotiations to final transactions, we ensure a smooth and transparent buying experience. </p>
                        </div>
                    </div>
                </div>
            </div>
